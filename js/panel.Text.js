...
(function (extend) {
    ...
    extend.fontFamilyData = [
        ...
        },
        {
            ...
            id: "M54",
            submenu: [
                {text: "FACE OFF M54", value: "FaceOff", imageSrc: "img/fonts/FACE OFF M54.png"},
                {text: "Jersey M54", value: "Jersey", imageSrc: "img/fonts/Jersey M54.png"},
                {text: "Superstar M54", value: "Superstar", imageSrc: "img/fonts/Superstar M54.png"},
                {text: "Wanted M54", value: "Wanted", imageSrc: "img/fonts/Wanted M54.png"},
            ]
        },
    ];
